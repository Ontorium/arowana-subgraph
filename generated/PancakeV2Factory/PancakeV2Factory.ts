...
export class PancakeV2Factory extends ethereum.SmartContract {
  static bind(address: Address): PancakeV2Factory {
    return new PancakeV2Factory("PancakeV2Factory", address);
  }
}
